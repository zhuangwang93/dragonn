...
if __name__ == '__main__':
    ...
    if not os.path.exists("logs/resnet50/") and hvd.rank() == 0:
        os.makedirs("logs/resnet50/")
    work_dir = "logs/resnet50/"
    ...
    optimizer = optim.SGD(model.parameters(), momentum=0.9, lr=args.base_lr * lr_scaler, weight_decay=5e-4)
